...
namespace TTC2017.LiveContest.SimpleCodeDOM
{
    ...
    /// <summary>
    /// The default implementation of the ParameterReferenceExpression class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/LiveContest/SimpleCodeDOM#//Parame" +
        "terReferenceExpression")]
    public partial class ParameterReferenceExpression : Expression, IParameterReferenceExpression, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ParameterReferenceExpressionReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.LiveContest.SimpleCodeDOM.ParameterReferenceExpression.ClassInstance)).Resolve("Parameter")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the ParameterReferenceExpression class
        /// </summary>
        public class ParameterReferenceExpressionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ParameterReferenceExpression _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ParameterReferenceExpressionReferencedElementsCollection(ParameterReferenceExpression parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class ParameterProxy : ModelPropertyChange<IParameterReferenceExpression, IParameter>
        {
            ...
            public ParameterProxy(IParameterReferenceExpression modelElement) : 
