...
namespace TTC2017.LiveContest.RefinementsEcore
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/LiveContest/RefinementsEcore#//ERe" +
        "ference")]
    ...
    public partial class EReference : EStructuralFeature, IEReference, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://www.transformation-tool-contest.eu/2017/LiveContest/RefinementsEcore#//ERe" +
                            "ference")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.LiveContest.RefinementsEcore.EReference.ClassInstance)).Resolve("containment")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.LiveContest.RefinementsEcore.EReference.ClassInstance)).Resolve("resolveProxies")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.LiveContest.RefinementsEcore.EReference.ClassInstance)).Resolve("eOpposite")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.LiveContest.RefinementsEcore.EReference.ClassInstance)).Resolve("eKeys")));
        }
        ...
        private void EKeysCollectionChanging(object sender, NotifyCollectionChangingEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.LiveContest.RefinementsEcore.EReference.ClassInstance)).Resolve("Refines")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            if ((feature == "REFINES"))
            {
                this.Refines = ((IEReference)(value));
                return;
            }
        ...
        public class EReferenceReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.EOpposite).Concat(this._parent.EKeys).Concat(this._parent.Refines).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class RefinesProxy : ModelPropertyChange<IEReference, IEReference>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public RefinesProxy(IEReference modelElement) : 
